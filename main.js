document.addEventListener('DOMContentLoaded', () => {
            ...
            // Track currently selected book for per-book access links
...
const reviews = [
            ...
            if (optionA) {
                optionA.onclick = () => {
                    ...
                    if (url) {
                        ...
                        console.warn("paidLink is missing for selected book");
                    }
                };
            }
            if (optionB) {
                optionB.onclick = () => {
                    ...
                    if (url) {
                        ...
                        console.warn("freeLink is missing for selected book");
                    }
                };
            }
            ...
            window.openDetails = (id) => {
                ...
                // Keep selection in sync for Access modal
                selectedBook = book;
if (modalContent) {
            ...
            window.openAccessModal = (id) => {
                ...
                // Resolve selected book from id
                selectedBook = books.find(b => b.id === Number(id)) || selectedBook;
lastTriggerElement = document.activeElement;
